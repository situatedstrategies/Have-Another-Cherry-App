  ...
  return (
    <Modal
      ...
      footer={
        <button
          onClick={onClose}
          className="w-full py-2.5 text-xs font-bold text-white bg-natural-primary hover:bg-natural-dark rounded-full shadow-md transition-all cursor-pointer"
        >
          Got it
        </button>
      }
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-3 items-start bg-natural-bg/50 border border-natural-border rounded-xl p-3.5">
            ...
            <p className="text-xs text-natural-text leading-relaxed">
              ...
              range for each payment. You just log something in that range toward the pot —
